...
-- number of victories needed to win
VICTORY_NUM = 10
...
function love.update(dt)
    ...
    elseif gameState == 'play' then
        ...
        if ball.x < 0 then
            ...
            if player2Score == VICTORY_NUM then
                winningPlayer = 2
                gameState = 'done'
            else
                gameState = 'serve'
        ...
        if ball.x > VIRTUAL_WIDTH then
            ...
            if player1Score == VICTORY_NUM then
                winningPlayer = 1
                gameState = 'done'
            else
                gameState = 'serve'
    ...
    -- incoporate player1 AI movement
    if gameState == 'play' then
        -- ball moving towards player1
        if ball.dx < 0 then
            -- if paddle is above ball
            if player1.y + player1.width < ball.y then
                player1.dy = PADDLE_SPEED
            elseif player1.y > ball.y + ball.width then
                player1.dy = -PADDLE_SPEED
            else
                player1.dy = 0
            end
